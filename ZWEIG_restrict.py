...
parser.add_argument("enzymes", help="The restriction enzymes in a file in the 37e emboss format")
...
parser.add_argument("-r", "-reverse_sort", help="Reverse the order of result", action="store_true")
